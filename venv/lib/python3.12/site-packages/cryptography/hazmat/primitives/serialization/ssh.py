...
_SK_SSH_ED25519 = b"***REMOVED***ssh-ed25519@openssh.com"
_SK_SSH_ECDSA_NISTP256 = b"***REMOVED***ecdsa-sha2-nistp256@openssh.com"
...
class _SSHFormatSKEd25519:
    """
    The format of a ***REMOVED***ssh-ed25519@openssh.com public key is:

        string		"***REMOVED***ssh-ed25519@openssh.com"
        string		public key
    ...
    def get_public(self, data: memoryview) -> typing.NoReturn:
        ...
        raise UnsupportedAlgorithm(
            "***REMOVED***ssh-ed25519 private keys cannot be loaded"
        )


class _SSHFormatSKECDSA:
    """
    The format of a ***REMOVED***ecdsa-sha2-nistp256@openssh.com public key is:

        string		"***REMOVED***ecdsa-sha2-nistp256@openssh.com"
        string		curve name
        ec_point	Q
        string		application (user-specified, but typically "ssh:")
    """
    ...
    def get_public(self, data: memoryview) -> typing.NoReturn:
        ...
        # loading.
        raise UnsupportedAlgorithm(
            "***REMOVED***ecdsa-sha2-nistp256 private keys cannot be loaded"
        )
